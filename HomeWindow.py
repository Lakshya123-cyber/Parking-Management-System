...
class HomeScreen(QMainWindow):
    ...
    def addManagePage(self):
        ...
        self.table.setStyleSheet("background:#000")
        ...
        for smalldata in data:
            self.table.setItem.setStyleSheet("color: #000")
            ...
            self.button_exit.setStyleSheet(
                "color:#fff;padding:8px 0px;font-size:16px;background:green;border:1px solid white"
            )
    ...
    def addHistoryPage(self):
        ...
        self.table1.setRowCount(len(data))
        self.table1.setStyleSheet("background:#000")
        self.table1.setColumnCount(7)
